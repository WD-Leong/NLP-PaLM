...
import torch
import torch_palm as gpt_module
...
model_ckpt_dir  = "../PyTorch_Models/dialog_sw_torch_palm"
train_loss_file = "train_loss_dialog_sw_torch_palm.csv"
...
if restore_flag:
    ...
    gpt_optim.load_state_dict(ckpt['optim_state_dict'])
...
while n_iter < maximum_iter:
    ...
    for tmp_opt_group in gpt_optim.param_groups:
    ...
    tmp_loss = sub_batch_train_step(
        ...
        gpt_optim, seg_length=seq_length)
    ...
    if n_iter % save_step == 0:
        ...
        torch.save({
            ...
            'optim_state_dict': gpt_optim.state_dict()
            }, model_ckpt_dir)
